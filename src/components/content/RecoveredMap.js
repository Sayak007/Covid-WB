  ...
  function RecoveredMap() {
    ...
    const onMouseEnter = (geo, current = { value: 'NA' }) => {
      return () => {
        ...
        setTooltipContent(`<b style="font-size:17px; font-family=Muli;">${dist}</b> <br> Recovered: <b  style="font-size:15px;">${data1['West Bengal']['districtData'][geo.properties.district]['recovered']}</b> </br>`);
      };
    };
    ...
    return (
      <Row flexGrow={1} className={css(styles.container)}horizontal="center" >
        <Column wrap flexGrow={7} flexBasis="735px" className={css(styles.graphSection)}
            ...
            <font color="green" face="Muli"><h3 className="no-margin center"><center>RECOVERED</center></h3></font>
